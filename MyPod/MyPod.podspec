...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Louisiu" => "fsliu136@gmail.com" }
  # Or just: spec.author    = "Louisiu"
  # spec.authors            = { "Louisiu" => "fsliu136@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Louisiu"
